...
const AddToCartButton = ({
	...
	if (!product.is_salable) {
		return (
			<div className="old-price font-medium clear product-stock-qty-mobile-ivsp" id="cartButton">
						<p className="product-view-avail-out-of-stock" content="Out Of Stock"><b className="convert-test-v1-out-of-stock">Sold Out</b></p>
						...
						<div className="product-outofstock font-medium">
							...
							<span data-content="bar"></span>
								<input type="hidden" value="2018-08-15 18:40:41" id="current_date" />
								<input type="hidden" id="product_Id" value="1142567" />
								<input type="hidden" id="user_email" value="testvinay@indiarush.com" />
								<input type="hidden" id="user_name" value="test vinay" />
								<div className="price-clone-notify">
									<button id="product-notify-button" className="orange-button btn-cart" ><b>Notify me when this product is back in stock</b></button>
									<div>
	...
	return (
<div className="add-to-cart checkout-types product-page-add-to-cart-button product-page-add-to-cart-button-web product-page-add-to-cart-button-web-add-css NewChangePostionSize" id="cartButton">
