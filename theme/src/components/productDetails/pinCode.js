...
class Pincode extends Component{
	...
	super(props);
	 ...
	 this.state={pincodeShow:true,deliveryDetails:[],pincode:undefined,message:undefined,cod:undefined,deldate:undefined }
}
componentDidMount() {
		...
		{this.state.pincodeShow ? (
			<div className="defaultPin">
				 <div className="product-free-shipping-mob-qual-box">
					 <span className="product-free-shipping-mob-qual-subbox product-free-shipping-mob-qual-subbox-main" data-content="bar">CONGRATULATIONS! You qualify for free shipping!</span>
				 </div>
				 <div className="product-pincode-checker font-medium">
						 <div className="product-pincode-checker-box">
							 ...
							 <input maxlength="6" id="product-pincode-checker" onChange={(e) => this.checkPincode(e)} className="product-pincode-checker-input" type="tel"/>
							 ...
							 <a className="productPincodeAction" id="product-pincode-checker-button" onClick={(e) => this.checkPincode(e)} title="Check Your Pincode">Check</a>
						 </div>
				 </div>
		 </div>
      ) : (
				<div className="product-pincode-checker-bottom font-medium">
						<div className="product-pincode-checker-message">
							 <div className="pincodeRight">For Pincode <b>{this.state.pincode}</b>
							 <br/>
									(<a className="product-pincode-checker-retry" onClick={() => this.showPincode()}>Change</a>)
							 </div>
								 <div className="pincodeLeft">
									 ...
									 <br/>
										 ...
										 <br/>
											 {this.state.deldate && (
							           <span className="pincodeLeft">Get it By : <b>{this.state.deldate}</b></span>
							        )}
