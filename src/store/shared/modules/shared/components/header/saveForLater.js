		...
		<div>
			<div className="columns is-mobile">
				...
				<div className="column">
					...
					<div className="save-for-later-mrp">
						{' '}
						{helper.formatCurrency(item.price, settings)}
					</div>
					<div className="save-for-later-offer-price">
						{' '}
						{helper.formatCurrency(item.special_price, settings)}
					</div>
				</div>
			</div>
			...
			<div className="saveLaterBtns">
				<div className="cart-buttons">
					<div
						...
						onClick={() => moveSaveForLaterToCart(item.product_id)}
					>
						<div className="movetocart">Move to cart</div>
					</div>
					<div
						className="new-cart-remove right"
						onClick={() => removeFromSaveForLater(item.product_id)}
					>
				...
				<div className="mini-cart">
					...
					<div className="columns is-mobile is-gapless">
						<div className="column is-12">
							<p>
								*We will notify when sold out items are available for purchase
								again.
							</p>
						</div>
					</div>
