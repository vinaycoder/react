...
export const SET_SELECTED_USER_ADDRESS = 'SET_SELECTED_USER_ADDRESS';
export const SET_SELECTED_USER_CARD_DETAILS = 'SET_SELECTED_USER_CARD_DETAILS';

export const CREATE__GUEST_USER_REQUEST = 'CREATE__GUEST_USER_REQUEST';

export const CURRENT_ORDER = 'CURRENT_ORDER';
export const HOMEPAGE_DETAILS = 'HOMEPAGE_DETAILS';
