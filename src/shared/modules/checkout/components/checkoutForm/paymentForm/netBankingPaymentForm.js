           ...
           <table className="order-summary-table">
             <tbody>
               <tr>
                 ...
                 <td className="CheckoutValue">
                   <span className="price">Rs. 6,270</span>
                 </td>
               </tr>
               <tr>
                 <td className="CheckoutTitle">Discount (IRFLAT100)</td>
               ...
               <tr className="grand-total">
                 ...
                 <td className="CheckoutValue"><span className="price">Rs. 6,170</span></td>
               </tr>
             </tbody>
           </table>
         </div>
