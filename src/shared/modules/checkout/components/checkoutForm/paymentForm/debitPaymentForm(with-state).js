                                       ...
                                       <li className="checkout-card-container">
                                           <div className="checkout-card-block card-select">
                                               ...
                                               <div className="checkout-card-select">
                                                   <select size="1" id="debitCards" onChange={e=>this.props.handleChange(e)} name="newdebitCards" className="validate-select" autcomplete="off">
                                           ...
                                           <div className="checkout-card-block card-name">
                                               ...
                                               <div className="checkout-card-input">
                                                   <input type="text" name="newccnameDebit" onChange={e=>this.props.handleChange(e)} id="newccnameDebit" placeholder="Name on card" autcomplete="off" />
                                               </div>
                                           </div>
                                           <div className="checkout-card-block card-date">
                                               ...
                                               <div className="checkout-card-input">
                                                   <select size="1" name="newccexpmonDebit" onChange={e=>this.props.handleChange(e)} id="newccexpmonDebit" className="validate-select" autcomplete="off" >
                                               ...
                                               <div className="checkout-card-input">
                                                   <select size="1" name="newccexpyrDebit" onChange={e=>this.props.handleChange(e)} id="newccexpyrDebit" className="validate-select" autcomplete="off">
                                           ...
                                           <div className="checkout-card-block card-cvv">
                                               ...
                                               <div className="checkout-card-input">
                                                   <input id="checkoutDebitCVVNew" onChange={e=>this.props.setCardPropsCvv(e.target.value)} type="tel" name="newccvvDebit" maxLength="3" size="5" className="input-field required-entry debit-new-cvv" placeholder="CVV" autcomplete="off" />
